...
export const SAMPLE_NEWS: NewsArticle[] = [
  {
    ...
    category: { _id: 'cat-1', name: 'World', color: 'bg-indigo-500', slug: 'world' },
  ...
  },
  {
    ...
    category: { _id: 'cat-2', name: 'Technology', color: 'bg-green-500', slug: 'technology' },
  ...
  },
  {
    ...
    category: { _id: 'cat-3', name: 'Sports', color: 'bg-orange-500', slug: 'sports' },
  ...
  },
  {
    ...
    category: { _id: 'cat-4', name: 'Health', color: 'bg-pink-500', slug: 'health' },
  ...
  },
  {
    ...
    category: { _id: 'cat-5', name: 'Business', color: 'bg-blue-500', slug: 'business' },
  ...
  },
  {
    ...
    category: { _id: 'cat-6', name: 'Entertainment', color: 'bg-purple-500', slug: 'entertainment' },
